...
date: 2024-06-01
description: "Le Kernel et le Développement de Logiciels Malveillants"
categories: ["low-level"]
tags: ["kernel", "security", "malware", "system-security", "architecture"]
toc: true
---
...
1. **Le processeur (CPU)** : L'unité centrale de traitement exécute les instructions des programmes.
2. **La mémoire (RAM)** : La mémoire vive sert à stocker temporairement les données et les instructions en cours d'exécution.
3. **Les périphériques d'entrée et de sortie (I/O)** : Ils permettent à l'ordinateur de communiquer avec le monde extérieur.
