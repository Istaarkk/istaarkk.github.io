...
process_file() {
  ...
  # Créer le nouveau fichier avec frontmatter
...
EOF
  ...
  echo "Moved: $file -> content/posts/$dest_dir/$clean_name.md"
}
...
echo "All markdown files have been processed and moved to appropriate directories." 